(function () {
    ...
    var basicBot = {
        ...
        chatLink: "https://dl.dropboxusercontent.com/s/r3tl1kreg0svc2u/tradu%C3%A7%C3%A3o.json",
        chat: null,
        loadChat: loadChat,
        ...
        commands: {
            ...
            cookieCommand: {
                ...
                rank: 'user',
                type: 'startsWith',
                cookies: ['Quer saber se é bolacha ou biscoito',
                    'Te deu uma bolacha vencida.',
                    'Te deu um cookie feito com amor :heart:',
                    'Deu-lhe uma rosquinha de chocolate',
                    'Te deu um Oreo e uma lata de Coca.',
                    'Te deu um pacote de bolacha salgada.'
                ],
                getCookie: function () {
                    var c = Math.floor(Math.random() * this.cookies.length);
                    return this.cookies[c];
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            var user = basicBot.userUtilities.lookupUserName(name);
                            if (user === false || !user.inRoom) {
                                return API.sendChat("/me Bolacha ou biscoito?");
                            }
                            else if (user.username === chat.un) {
                                return API.sendChat("/me Bolacha ou biscoito?");
                            }
            ...
            punirCommand: {
                ...
                cookies: ['Te bateu com um skate!',
                    'Enfiou um peixe elétrico no seu cu',
                    'Tacou uma pedra na sua cara!',
                    'Deu um soco na sua cara :facepunch:',
                    'Deu um tiro na sua testa, ai :gun:',
                    'Chutou seu saco!',
                    'Te deu um pão envenenado... E morreu...',
                    'Te deixou um oco',
                    'Arrancou seu braço',
                    'Enfiou um cabo de vassoura no seu cu'
                ],
                getCookie: function () {
                    var c = Math.floor(Math.random() * this.cookies.length);
                    return this.cookies[c];
            ...
            helpCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var link = "http://i.imgur.com/eSp2Y3x.png";
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat("Esse bot foi editado por Josh.");
                    }
                }
            },
